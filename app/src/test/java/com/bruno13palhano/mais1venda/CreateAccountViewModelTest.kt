...
internal class CreateAccountViewModelTest {
    ...
    fun `EmailChanged Event should update email property in the State with the provided email`() =
        runTest {
            ...
            collectStateHelper(
                ...
                assertationsBlock = { assertThat(viewModel.container.state.value.email).isEqualTo(expected) },
            )
        }
    ...
    fun `CompanyNameChanged Event should update companyName property in the State with the provided companyName`() =
        runTest {
            ...
            collectStateHelper(
                stateCollector = { viewModel.container.state.collect() },
                eventsBlock = { viewModel.handleEvent(CreateAccountEvent.CompanyNameChanged(expected)) },
                assertationsBlock = { assertThat(viewModel.container.state.value.companyName).isEqualTo(expected) },
            )
        }
    ...
    fun `PhoneChanged Event should update phone property in the State with the provided phone`() =
        runTest {
            ...
            collectStateHelper(
                ...
                assertationsBlock = { assertThat(viewModel.container.state.value.phone).isEqualTo(expected) },
            )
        }
    ...
    fun `AddressChanged Event should update address property in the State with the provided address`() =
        runTest {
            ...
            collectStateHelper(
                ...
                assertationsBlock = { assertThat(viewModel.container.state.value.address).isEqualTo(expected) },
            )
        }
    ...
    fun `PasswordChanged Event should update password property in the State with the provided password`() =
        runTest {
            ...
            collectStateHelper(
                ...
                assertationsBlock = { assertThat(viewModel.container.state.value.password).isEqualTo(expected) },
            )
        }
    ...
    fun `ConfirmPasswordChanged Event should update confirmPassword property in the State with the provided confirmPassword`() =
        runTest {
            ...
            collectStateHelper(
                stateCollector = { viewModel.container.state.collect() },
                eventsBlock = { viewModel.handleEvent(CreateAccountEvent.ConfirmPasswordChanged(expected)) },
                assertationsBlock = { assertThat(viewModel.container.state.value.confirmPassword).isEqualTo(expected) },
            )
        }
    ...
    @Test
    fun `CreateAccount Event with invalid email should emit ShowError side effect`() =
        runTest {
    ...
    @Test
    fun `CreateAccount Event with invalid password should emit ShowError side effect`() =
        runTest {
            ...
            collectEffectHelper(
                ...
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.PasswordChanged(password = initialState.password))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                }
            )
        }
    ...
    fun `CreateAccount Event with invalid confirmPassword should emit ShowError side effect`() =
        runTest {
            ...
            collectEffectHelper(
                ...
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.ConfirmPasswordChanged(confirmPassword = initialState.confirmPassword))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                }
            )
        }
    ...
    fun `CreateAccount Event with invalid companyName should emit ShowError side effect`() =
        runTest {
            ...
            collectEffectHelper(
                ...
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.CompanyNameChanged(companyName = initialState.companyName))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                },
            )
        }
    ...
    @Test
    fun `CreateAccount Event with invalid phone should emit ShowError side effect`() =
        runTest {
            ...
            collectEffectHelper(
                ...
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.PhoneChanged(phone = initialState.phone))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                }
            )
        }
    ...
    @Test
    fun `CreateAccount Event with invalid address should emit ShowError side effect`() =
        runTest {
            ...
            collectEffectHelper(
                ...
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.AddressChanged(address = initialState.address))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                },
            )
        }
    ...
    @Test
    fun `CreateAccount Event with invalid email should update isError property in the State to true`() =
        runTest {
    ...
    @Test
    fun `CreateAccount Event with invalid password should update isError property in the State to true`() =
        runTest {
            ...
            collectStateHelper(
                stateCollector = { viewModel.container.state.collect() },
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.PasswordChanged(password = expected.password))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                },
                assertationsBlock = { assertThat(viewModel.container.state.value).isEqualTo(expected) },
            )
    ...
    @Test
    fun `CreateAccount Event with invalid confirmPassword should update isError property in the State to true`() =
        runTest {
            ...
            collectStateHelper(
                stateCollector = { viewModel.container.state.collect() },
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.ConfirmPasswordChanged(confirmPassword = expected.confirmPassword))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                },
                assertationsBlock = { assertThat(viewModel.container.state.value).isEqualTo(expected) },
            )
    ...
    @Test
    fun `CreateAccount Event with invalid companyName should update isError property in the State to true`() =
        runTest {
            ...
            collectStateHelper(
                stateCollector = { viewModel.container.state.collect() },
                eventsBlock = {
                    viewModel.handleEvent(CreateAccountEvent.CompanyNameChanged(companyName = expected.companyName))
                    viewModel.handleEvent(CreateAccountEvent.CreateAccount)
                },
                assertationsBlock = { assertThat(viewModel.container.state.value).isEqualTo(expected) },
            )
    ...
    @Test
    fun `CreateAccount Event with invalid phone should update isError property in the State to true`() =
        runTest {
    ...
    @Test
    fun `CreateAccount Event with invalid address should update isError property in the State to true`() =
        runTest {
